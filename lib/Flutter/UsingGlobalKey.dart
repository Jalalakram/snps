...
void usingGlobalKey() => runApp(new MyApp());
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new MyHomePage(),
      routes: { TabsPage.routeName: (context) => new TabsPage(),},
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: new ListView(
        children: <Widget>[
          new ListTile( title: new Text("Home Body"),),
          new ListTile( title: new RaisedButton(
            child: new Text("Route to Tabs".toUpperCase()),
            onPressed: () { Navigator.of(context).pushNamed(TabsPage.routeName);}),
),],),);}}

...
void fontAwesomeFlutter() => runApp(FontAwesomeGalleryApp());
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData.light().copyWith(
        iconTheme: IconThemeData(size: 36.0, color: Colors.deepOrangeAccent),
        textTheme: TextTheme(bodyText2: TextStyle(fontSize: 12.0, color: Colors.black),),
      ),
                  ...
                  builder: (BuildContext context) {
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Hero(tag: icon,
                          child: FaIcon(icon.iconData, size: 300,),
                        ),
                      ),
                    );
                  },

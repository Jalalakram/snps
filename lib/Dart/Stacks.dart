//@ https://medium.com/@parthraval217/flutter-everything-about-stack-48fe809874e9
import 'package:flutter/material.dart';

void stacks() => runApp(MaterialApp(home: Home(),));
          ...
          children: <Widget>[
              ...
              child: Stack(alignment: Alignment.topCenter, children: <Widget>[
                  Positioned(top: 100, left: 100,
                    child: Container(height: 300, width: 300,
                      child: Center(child: Text('Positioned')), color: Colors.amber,),
                  ),
                  Align(alignment: Alignment.topRight,
                    child: Container(height: 200, width: 200,
                      child: Center(child: Text('Aligned')), color: Colors.brown,),
                  ),
                  Container(height: 100, width: 100,
                    child: Center(child: Text('Non-Positioned')), color: Colors.cyan,
                  ),
                ],
              )
            ),
            ...
            Container(color: Colors.pinkAccent,
              ...
              child: Stack(textDirection: TextDirection.rtl,
                children: <Widget>[
                  Text("Flutter from right to left", style: TextStyle(color: Colors.white, fontSize: 18),)
                ],
              ),
            ),

            //# textDirection => left to right...
            Container(margin: EdgeInsets.only(top: 15), color: Colors.blueAccent,
              constraints: BoxConstraints.expand(height: 60),
              child: Stack(
                textDirection: TextDirection.ltr, children: <Widget>[
                  Text("Flutter from left to right", style: TextStyle(color: Colors.white, fontSize: 18),)
                ],
              ),
            ),
